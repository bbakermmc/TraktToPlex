...
namespace TraktToPlex.Plex.Models.Shows
{
    public class Episode : IHasId
    {
        ...
        [JsonProperty("index")] public int No { get; set; }
        [JsonProperty("viewCount")] public int ViewCount { get; set; }
        [JsonProperty("ratingKey")] public long RatingKey { get; set; }
        [JsonProperty("key")] public string Key { get; set; }
        [JsonProperty("parentRatingKey")] public long ParentRatingKey { get; set; }
        [JsonProperty("grandparentRatingKey")] public long GrandparentRatingKey { get; set; }
        [JsonProperty("guid")] public string Guid { get; set; }
        [JsonProperty("parentGuid")] public string ParentGuid { get; set; }
        [JsonProperty("grandparentGuid")] public string GrandparentGuid { get; set; }
        [JsonProperty("type")] public string Type { get; set; }
        [JsonProperty("title")] public string Title { get; set; }
        [JsonProperty("titleSort")] public string TitleSort { get; set; }
        [JsonProperty("grandparentKey")] public string GrandparentKey { get; set; }
        ...
        [JsonProperty("originallyAvailableAt")]public DateTimeOffset OriginallyAvailableAt { get; set; }
